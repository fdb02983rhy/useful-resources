...
export const resources: Resource[] = [
  ...
  },
  {
    ...
    "kind": "article",
    "sourceUrl": "https://x.com/0xwhrrari/status/2093685107534000560?s=46&t=ylgcGz4nmoG6QcDWJRetoQ",
    "added": "2026-09-26",
    "status": "reference",
    "topics": [
      "agentic-engineering",
    ...
    "summary": "Rari (@0xwhrrari) presents a checklist for making agents reliable through their execution environment: bounded tasks, discoverable knowledge, explicit tool contracts, durable state, verification, permissions, and recoverable traces.",
    "whySaved": [
    ...
    "highlights": [
      "Define success before execution and use a small project guide to route agents to relevant knowledge instead of loading every document.",
      "Give tools predictable outputs and failure states; persist decisions, artifacts, and outstanding work outside the conversation.",
      "Require evidence from tests, logs, screenshots, or validators before advancing. Keep authorization for consequential actions outside the model.",
      "Bound repair loops with retries, budgets, and escalation. Record traces and a compact completion receipt so failures and regressions can be investigated."
    ]
  },
  {
  ...
  },
  {
    ...
    "summary": "TypeSafe introduces Jev, an early-access model for fast, typed probabilistic decisions rather than free-form text. The announcement covers its training approach, parallel sampling, workflow evaluations, and real-time demonstrations.",
    "whySaved": [
      "Explores embedding uncertain decisions into ordinary software workflows."
    ],
    "highlights": [
      "Reinforcement Learning for Calibrated Decisions (RLCD) targets calibrated probabilities; outputs follow predefined schemas and are sampled in parallel.",
      "Suggested uses include classification, routing, scoring, and verification. Doom and Wikipedia-navigation demos illustrate latency-sensitive decisions.",
      "TypeSafe reports substantial speed and cost gains, but its workflow evaluations compare against reference-model probabilities rather than ground-truth labels. Team-authored workflows, comparison settings, and input length affect results.",
      "The article's zero-type-error claim rests on guaranteed schema matching, not empirical proof that every decision is correct."
    ]
  },
  {
